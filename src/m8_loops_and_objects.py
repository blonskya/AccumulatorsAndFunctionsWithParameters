...
def draw_circles1():
    ...
    print('--------------------------------------------------')
    newwin = rg.RoseWindow(400, 400)
    anchor = rg.Point(200, 200)
    for k in range(21):
        unprtcrc = rg.Circle(anchor, (10*k))
        unprtcrc.attach_to(newwin)
        newwin.render(0.05)
...
def draw_circles2():
    ...
    newwin = rg.RoseWindow(400, 400)
    for k in range(21):
        posit = rg.Point(((20 * k)+50), 100)
        unprtcrc = rg.Circle(posit, 10)
        unprtcrc.fill_color = 'blue'
        unprtcrc.attach_to(newwin)
        newwin.render(0.05)
...
def draw_circles3():
    ...
    print('--------------------------------------------------')
    newwin = rg.RoseWindow(400, 400)
    anchor = rg.Point(200, 150)
    for k in range(100):
        unprtcrc = rg.Circle(anchor, k+1)
        unprtcrc.attach_to(newwin)
        newwin.render(0.01)
...
def draw_cosines_and_sines():
    ...
    newwin = rg.RoseWindow(400, 400)
    for k in range(101):
        posit = rg.Point(200+(80+math.cos(k)), 200+(80+math.sin(k)))
        unprtcrc = rg.Circle(posit, 10)
        unprtcrc.attach_to(newwin)
        newwin.render(0.01)
